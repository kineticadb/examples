...
/* This demo creates a real time system for monitoring financial risk. */
/* ------------------------------------------------------------------- */
...
/* -------------------------------------- */
/* Worksheet: Set up outbound decisioning */
/* -------------------------------------- */
...
WITH OPTIONS 
(
    DESTINATION = '<PASTE WEBHOOK URL HERE' -- 'Paste Webhook URL'
);
