...
This workbook illustrates both these routes. 

First, we will use a CData connector to get data from a googlesheet into Kinetica. After that, we will load and use a Postgres driver into Kinetica to interact with a Postgres data base.
